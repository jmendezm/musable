...
export class RoomModel {
  ...
  static async updatePlaybackState(roomId: number, updates: {
    current_song_id?: number;
    current_position?: number;
    is_playing?: boolean;
    play_started_at?: string;
  ...
  static async getUserRole(roomId: number, userId: number): Promise<RoomRole | null> {
    const db = Database;
  ...
  static async updateUserRole(roomId: number, userId: number, role: RoomRole): Promise<void> {
    const db = Database;
  ...
  static async handleHostTransfer(roomId: number, leavingUserId: number): Promise<void> {
    const db = Database;
  ...
  static async updateParticipantLastSeen(roomId: number, userId: number): Promise<void> {
    const db = Database;
  ...
  static async addToQueue(roomId: number, songId: number, userId: number): Promise<void> {
    const db = Database;
  ...
  static async getQueueItem(roomId: number, queueItemId: number): Promise<RoomQueueItem | null> {
    const db = Database;
  ...
  static async removeFromQueue(roomId: number, queueItemId: number): Promise<void> {
    const db = Database;
